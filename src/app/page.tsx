              ...
              <div className="max-w-7xl mx-auto flex h-full flex-col justify-center px-4 py-16">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-100">
                    ...
                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-ciprel-black mb-3">La communication autour de la Démarche Compétence se structure autour de deux axes majeurs :</h4>
                        <ul className="space-y-2 ml-4">
                          <li className="text-gray-700">
                            <span className="font-semibold text-ciprel-orange-600">•</span> La valorisation des métiers au travers des compétences techniques, comportementales et pratiques professionnelles
                          </li>
                          <li className="text-gray-700">
                            <span className="font-semibold text-ciprel-orange-600">•</span> Et la mise en avant de nos valeurs FEERIC à travers des actions concrètes
                          </li>
                        </ul>
                      </div>

                      <div className="border-t pt-4">
                        <h4 className="font-semibold text-ciprel-black mb-2">Vous découvrirez tout au long du programme :</h4>
                        <ul className="space-y-2 ml-4 text-sm">
                          ...
                          <li className="text-gray-700"><span className="font-semibold text-ciprel-green-600">•</span> Des quiz et témoignages collaborateurs</li>
                          <li className="text-gray-700"><span className="font-semibold text-ciprel-green-600">•</span> Ainsi que tous les supports, référentiels et outils de la Démarche Compétence à télécharger</li>
                        </ul>
                      </div>
                    </div>
                  </div>
            ...
            <section className="h-full overflow-y-auto bg-gradient-to-br from-ciprel-green-50 via-white to-gray-50">
              <div className="max-w-7xl mx-auto px-4 py-16">
                ...
                <div className="relative px-12 min-h-[600px]">
                  <Swiper
                    onSwiper={(swiper) => {
                      swiperDefinitionsRef.current = swiper
                    }}
                    ...
                    observeParents={true}
                    nested={true}
                    className="w-full mb-8 definitions-swiper h-full"
                    style={{
                  ...
                  >
                    ...
                    {/* Slide 4: Parcours d'apprentissage - Quiz & Évaluation */}
                    <SwiperSlide>
                      <div className="bg-white rounded-xl shadow-lg p-8 md:p-10 mb-8 min-h-[500px] flex flex-col justify-center">
                        <div className="text-center mb-8">
                          <span className="bg-ciprel-orange-100 text-ciprel-orange-800 px-4 py-2 rounded-full text-sm font-semibold inline-block mb-4">
                ...
                <div className="text-center mt-6 mb-2">
                  <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md border border-gray-200">
                    <span className="text-sm font-semibold text-ciprel-orange-600">
                      {definitionCarouselIndex + 1}
                    </span>
