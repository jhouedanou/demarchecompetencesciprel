...
import { Stack, Text, DefaultButton, MessageBar, MessageBarType, ProgressIndicator } from '@fluentui/react';
const ProgressTracker = ({ onNavigate }) => {
    ...
    return (React.createElement(Stack, { tokens: { childrenGap: 30 }, styles: { root: { maxWidth: 900, margin: '0 auto' } } },
        ...
        React.createElement(Stack, { horizontal: true, wrap: true, tokens: { childrenGap: 20 }, horizontalAlign: "center" }, mockProgress.map((item, index) => (React.createElement(Stack, { key: index, styles: {
                root: {
                    width: 250,
                    padding: 20,
